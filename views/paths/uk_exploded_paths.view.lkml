include: "/views/intermediate/uk_unique_events.view.lkml"
...
view: uk_exploded_paths {
  ...
  derived_table: {
    ...
    sql:
        ...
        FROM ${uk_unique_events.SQL_TABLE_NAME} aue
        ...
        WHERE aue.country = 'UK'  -- Filter for UK data
          ;;
  }
}